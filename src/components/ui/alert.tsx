...
/**
 * Callout for a message that must interrupt the flow — a save that failed, a
 * figure that cannot be trusted. `role="alert"` so it is announced.
 */
function Alert({
  className,
  variant,
...
/** Single-line heading of an alert. */
...
/** Body of an alert, for the explanation under the title. */
